...
program_version_link="https://raw.githubusercontent.com/glorygods/onekey-install-shell/master/frps/version.sh"
str_install_shell=https://raw.githubusercontent.com/glorygods/onekey-install-shell/master/frps/install-frps.sh
shell_update(){
    fun_clangcn "clear"
...
fun_clangcn(){
    ...
    echo ""
    echo "+---------------------------------------------------------+"
    echo "|        frps for Linux Server, Written by GloryGods       |"
    echo "+---------------------------------------------------------+"
